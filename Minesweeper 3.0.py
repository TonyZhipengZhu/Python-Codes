...
class GUI:
    ...
    def GUIbase(self):
        ...
        tkinter.Label(a.root2, text="flags left:"+str(board.flags),relief=RAISED,width=10,height=10).grid(row=350,column=10)
    ...
    def GUI_display(self):
        for j,row in enumerate(self.board):
            for i,column in enumerate(row):
                ...
                self.L.bind('<Button-3>',lambda e3,i=i,j=j: BIGboy.clickRight(i,j,e3))
